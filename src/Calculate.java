...
public class Calculate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Salary per Hours");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        ArrayList<Employee> arr=Emp.getArrayList();
        int flag=0;
        double total = 0;
        for(int i=0;i<arr.size();i++){
             if(Integer.parseInt(jTextField1.getText())==arr.get(i).getId()){
                total =arr.get(i).getHours_worked()* Double.parseDouble(jTextField2.getText());
                jLabel3.setVisible(true);
                jLabel3.setText("Salary is "+total);
            return;
               
              }
        }
        jLabel3.setVisible(true);
        jLabel3.setText("Sorry Employee does not exist!");
